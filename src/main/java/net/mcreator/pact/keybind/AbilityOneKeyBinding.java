...
import net.mcreator.pact.procedures.AbilityOneActiveProcedure;
...
public class AbilityOneKeyBinding extends DohtitansModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public AbilityOneKeyBinding(DohtitansModElements instance) {
		super(instance, 78);
	...
	public void initElements() {
		keys = new KeyBinding("key.dohtitans.ability_one", GLFW.GLFW_KEY_Z, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			AbilityOneActiveProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
