...
import net.mcreator.pact.procedures.PureTitanShiftedSpawnProcedure;
...
public class PureTitanShiftedEntity extends DohtitansModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.75f)).build("pure_titan_shifted").setRegistryName("pure_titan_shifted");

	public PureTitanShiftedEntity(DohtitansModElements instance) {
		super(instance, 72);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PureTitanShiftedGeckolibEntity());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13108, -26215, new Item.Properties().group(DOHTitansItemGroup.tab))
				.setRegistryName("pure_titan_shifted_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IAnimatable {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			PureTitanShiftedSpawnProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
