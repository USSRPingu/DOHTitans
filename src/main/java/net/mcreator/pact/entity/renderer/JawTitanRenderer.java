...
@OnlyIn(Dist.CLIENT)
public class JawTitanRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(JawTitanEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelJawTitan(), 0.5f) {
