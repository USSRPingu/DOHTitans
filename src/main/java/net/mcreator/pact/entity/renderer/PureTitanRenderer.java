...
@OnlyIn(Dist.CLIENT)
public class PureTitanRenderer extends GeoEntityRenderer<PureTitanEntity.CustomEntity> {
	@Override
	public ResourceLocation getEntityTexture(PureTitanEntity.CustomEntity entity) {
		return new ResourceLocation("dohtitans:textures/entities/pureskin.png");
	}

	public PureTitanRenderer(EntityRendererManager renderManager) {
		super(renderManager, new PureTitanModelProcedure());
		this.shadowSize = 0.5F;
	}

	@Override
	public void renderEarly(PureTitanEntity.CustomEntity animatable, MatrixStack stackIn, float ticks, IRenderTypeBuffer renderTypeBuffer,
	...
	@Override
	public RenderType getRenderType(PureTitanEntity.CustomEntity animatable, float partialTicks, MatrixStack stack,
