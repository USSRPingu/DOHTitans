...
@OnlyIn(Dist.CLIENT)
public class PureTitanShiftedRenderer extends GeoEntityRenderer<PureTitanShiftedEntity.CustomEntity> {
	@Override
	public ResourceLocation getEntityTexture(PureTitanShiftedEntity.CustomEntity entity) {
		return new ResourceLocation("dohtitans:textures/entities/pureskin.png");
	}

	public PureTitanShiftedRenderer(EntityRendererManager renderManager) {
		super(renderManager, new PureTitanShiftedModelProcedure());
		this.shadowSize = 0.5F;
	}

	@Override
	public void renderEarly(PureTitanShiftedEntity.CustomEntity animatable, MatrixStack stackIn, float ticks, IRenderTypeBuffer renderTypeBuffer,
	...
	@Override
	public RenderType getRenderType(PureTitanShiftedEntity.CustomEntity animatable, float partialTicks, MatrixStack stack,
