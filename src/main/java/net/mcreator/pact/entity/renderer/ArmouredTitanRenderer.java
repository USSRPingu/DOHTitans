...
@OnlyIn(Dist.CLIENT)
public class ArmouredTitanRenderer extends GeoEntityRenderer<ArmouredTitanEntity.CustomEntity> {
	@Override
	public ResourceLocation getEntityTexture(ArmouredTitanEntity.CustomEntity entity) {
		return new ResourceLocation("dohtitans:textures/entities/armouredskin.png");
	}

	public ArmouredTitanRenderer(EntityRendererManager renderManager) {
		super(renderManager, new ArmouredTitanModelProcedure());
		this.shadowSize = 0.5F;
	}

	@Override
	public void renderEarly(ArmouredTitanEntity.CustomEntity animatable, MatrixStack stackIn, float ticks, IRenderTypeBuffer renderTypeBuffer,
	...
	@Override
	public RenderType getRenderType(ArmouredTitanEntity.CustomEntity animatable, float partialTicks, MatrixStack stack,
